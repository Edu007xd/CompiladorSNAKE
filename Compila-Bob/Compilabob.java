...
public class Compilabob/*@bgen(jjtree)*/implements CompilabobTreeConstants, CompilabobConstants {/*@bgen(jjtree)*/
  protected JJTCompilabobState jjtree = new JJTCompilabobState();String errormsg="",datos = "";
    ...
    //--------------------------------------------------------
        public static void main(String args[])  {
            ...
            pe.printStackTrace();
                        ...
                        System.out.println("\u005cnEXCEPTION e MAIN\u005cn" +"Sentencias incorrectas encontradas: "+compilador.sentencias_inco);
                }
                catch( TokenMgrError e ) {
                        System.out.println( "Error de Token" );
                }
                if(compilador.errormsg == "\u005cn" && compilador.sentencias_inco == 0){
                        System.out.println("An"+"\u00e1"+"lisis l"+"\u00e9"+"xico y sint"+"\u00e1"+"ctico ejecutados con "+"\u00e9"+"xito");
                }else{
                        System.out.println(compilador.errormsg);
                }
                System.out.println("FINAL PRINT\u005cn" +"Sentencias incorrectas encontradas: "+compilador.sentencias_inco);
                System.out.println("----- Pila Semantica ----"+ ClaseSemantica.tabla);
...
// Gramatica inicial que contiene el cuerpo basico del codigo
  final public SimpleNode Codigo() throws ParseException {/*@bgen(jjtree) Codigo */
        ASTCodigo jjtn000 = new ASTCodigo(JJTCODIGO);
        boolean jjtc000 = true;
        jjtree.openNodeScope(jjtn000);//Se inicializa 
...
// método cuerpo, lee un conjunto de sentencias tamaño n
  final public void Cuerpo() throws ParseException {/*@bgen(jjtree) Cuerpo */
...
if (jjtc000) {
  ...
  final public void Muestra() throws ParseException {/*@bgen(jjtree) Muestra */
...
if (jjtc000) {
  ...
  final public void Mensaje() throws ParseException {/*@bgen(jjtree) Mensaje */
...
if (jjtc000) {
  ...
  final public void Concatenacion() throws ParseException {/*@bgen(jjtree) Concatenacion */
...
//----------------------------------------------------------------------------------------------
//########  DECIDE IF-ELSE ##########
  final public void Decide() throws ParseException {/*@bgen(jjtree) Decide */
...
//
  final public void Ciclo_RepitoHastaQue() throws ParseException {/*@bgen(jjtree) Ciclo_RepitoHastaQue */
...
//		* Ya lo hara automaticamente las gramaticas auxiliares
  final public void Condicion_RepitoHQ() throws ParseException {/*@bgen(jjtree) Condicion_RepitoHQ */
...
if (jjtc000) {
  ...
  final public void Condi_inicio() throws ParseException {/*@bgen(jjtree) Condi_inicio */
...
if (jjtc000) {
  ...
  final public void Condi_limite() throws ParseException {/*@bgen(jjtree) Condi_limite */
...
//----------------------------------------------------------------------------------------------------------------------
  final public 
 void Ciclo_RepitoMientras() throws ParseException {/*@bgen(jjtree) Ciclo_RepitoMientras */
...
//----------------------------------------------------------------------------------------------------------------------
  final public void Declaracion() throws ParseException {/*@bgen(jjtree) Declaracion */
...
// Aqui el string del identificador (v1, num, i, etc.) es guardado en una clase con el mismo nombre de
   ...
   //******************COMENTARIOS PARA el analizador SEMANTICo, AÚN NO ES IMPORTANTE*********************
        ...
        if(ClaseSemantica.checkVariable(var).equals("")){
                ...
                errormsg = errormsg+"Error semantico en la linea " +var.beginLine +", columna "+var.beginColumn +", la variable "+ var.image + " ya  ha sido declarada \u005cr\u005cn";
...
//esto es la base 
  final public void AsignacionD() throws ParseException {/*@bgen(jjtree) AsignacionD */
...
if (jjtc000) {
  ...
  final public void Termino() throws ParseException {/*@bgen(jjtree) Termino */
...
if (jjtc000) {
  ...
  final public void Primario() throws ParseException {/*@bgen(jjtree) Primario */
...
//		"Operador matematico: " + this.name
  final public 
void Mas_menos() throws ParseException {/*@bgen(jjtree) Mas_menos */
...
if (jjtc000) {
  ...
  final public void Menoss() throws ParseException {/*@bgen(jjtree) Menoss */
...
if (jjtc000) {
  ...
  final public void MDM() throws ParseException {/*@bgen(jjtree) MDM */
...
// ############## OPERACIONES DE COMPARACION PARA IF O CICLOS  ####################
  final public void OpComparacion() throws ParseException {/*@bgen(jjtree) OpComparacion */
...
if (jjtc000) {
  ...
  final public void FactorL() throws ParseException {/*@bgen(jjtree) FactorL */
...
if (jjtc000) {
  ...
  final public void FactorR() throws ParseException {/*@bgen(jjtree) FactorR */
...
//Para cuando se necesite usar lexemas y no consumir la gramatica
  final public 
void Variable_IDEN() throws ParseException {/*@bgen(jjtree) Variable_IDEN */
...
if (jjtc000) {
  ...
  final public void Comparadores() throws ParseException {/*@bgen(jjtree) Comparadores */
...
if (jjtc000) {
  ...
  final public void LEER() throws ParseException {/*@bgen(jjtree) LEER */
...
if (jjtc000) {
  ...
  final public void Variable_dato() throws ParseException {/*@bgen(jjtree) Variable_dato */
...
if (jjtc000) {
  ...
  final public void Logicos() throws ParseException {/*@bgen(jjtree) Logicos */
  ASTLogicos jjtn000 = new ASTLogicos(JJTLOGICOS);
  boolean jjtc000 = true;
  jjtree.openNodeScope(jjtn000);
    try {
      switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
...
if (jjtc000) {
  ...
  final public void Operadores() throws ParseException {/*@bgen(jjtree) Operadores */
...
if (jjtc000) {
  ...
  void error_skipto(int puntocoma, int fincode, int finfile) throws ParseException {/*@bgen(jjtree) error_skipto */
...
jjtree.closeNodeScope(jjtn000, true);
  jjtc000 = false;
errores = "Simbolo: " + t.image + " no reconocido en la l\u00c3\u00adnea "+String.valueOf(t.beginLine)+" columna "+String.valueOf(t.endColumn)+"\u005cr\u005cn";
...
if (jjtc000) {
  ...
  final public void errorFinlinea() throws ParseException {/*@bgen(jjtree) errorFinlinea */
...
if (jjtc000) {
  ...
  final public void errorDOBLElinea() throws ParseException {/*@bgen(jjtree) errorDOBLElinea */
...
//GRAMATICAS DE ERROR PARA LA ESTRUCTURA DEL CODIGO COATL
  final public 
void ErrorNoinicio() throws ParseException {/*@bgen(jjtree) ErrorNoinicio */
...
if (jjtc000) {
  ...
  final public void ErrorNoSepINICIO() throws ParseException {/*@bgen(jjtree) ErrorNoSepINICIO */
...
if (jjtc000) {
  ...
  final public void ErrorNoSepFINAL() throws ParseException {/*@bgen(jjtree) ErrorNoSepFINAL */
...
if (jjtc000) {
  ...
  final public void ErrorNOFIN() throws ParseException {/*@bgen(jjtree) ErrorNOFIN */
  ...
  private boolean jj_3_6()
 {
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x10,0x8000,0x10000,0x20,0x20b40,0x20000,0x20b40,0x20000,0x0,0x0,0x0,0x0,0x20b40,0x20b40,0x20000,0x20b40,0x20000,0x0,0x20b40,0x20000,0x80000,0x20000,0x40003000,0x40003000,0x60000000,0x80000000,0x40002000,0x2000,0x60000000,0x80000000,0x0,0x0,0x0,0x0,0x9e00000,0x0,0x6000000,0xc0000000,};
   }
   private static void jj_la1_init_1() {
      jj_la1_1 = new int[] {0x0,0x0,0x0,0x0,0xc3c,0x0,0xc00,0x0,0x500,0x500,0x500,0x500,0xc3c,0xc3c,0x0,0xc3c,0x0,0x7c0,0xc3c,0x0,0x0,0x0,0x7c0,0x7c0,0x0,0x3,0x7c0,0x7c0,0x0,0x3,0x7c0,0x7c0,0x7c0,0x3c0,0x0,0x38,0x0,0x3,};
   }
